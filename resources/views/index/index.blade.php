        ...
        <ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
            <li class="layui-nav-item ">
                ...
                <dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-url="/Admin/Incomes/add" data-id='1' data-text="收入/支出记录">
                    ...
                    <dd>
                        <a href="javascript:;" data-url="/Admin/Payments/add" data-id='3' data-text="应收/应付记录">
            ...
            <li class="layui-nav-item ">
                ...
                <dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-url="/Admin/Accounts/capital" data-id='5' data-text="资金账户余额">
