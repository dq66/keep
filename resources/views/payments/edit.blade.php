            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-input-block">
                            <select name="is_types" class="layui-input sel">
                                ...
                                @else
                                    ...
                                    <option value="2" selected>应付</option>
                                @endif
                            </select>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="hidden" id="dl" value="{{$pay['types_id']}}">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="hidden" id="xl" value="{{$pay['parent_id']}}">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="money" value="{{$pay['money']}}" required lay-verify="required"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="date" name="term" value="{{$pay['term']}}" required lay-verify="required"
                                   placeholder="请输入金额" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea name="desc" id="desc" class="layui-textarea">{{$pay['desc']}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
